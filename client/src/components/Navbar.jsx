    ...
    <nav className=" fixed bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2"> 
          ...
          <a href="/Signup" className="inline-flex items-center justify-center px-5 py-3 text-base
           ...
           outline-blue-500"  id="loginButton">
            Sign up
          </a>
          
          {/* Hamburger button */}
          <button type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm
           text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 
           focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            onClick={() => setToggle((prev) => !prev)} aria-controls="navbar-sticky" aria-expanded={isNavExpanded}>
