  ...
  function handleForm(event){
      ...
      fetch("/api/quote",{
          ...
          if (data['Height'] > 0 && data['Height'] <= 12) {
              if (data['Weight'] >= 1 && data['Weight'] <= 20) {
                ...
                WeightCharges = (data['Weight'] - 20) * 0.50;
      ...
      return(
        ...
        <div className='w-full px-4 md:px-32 lg:px-24'>
            ...
            <form onSubmit={handleForm} className="bg-white rounded-lg shadow-xl p-8 mt-10 md:mt-0 border-indigo-600 ">
              <h4 className="text-2xl md:text-3xl font-bold text-center mb-6">Quotation</h4>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-7 gap-4  mb-6">
                  ...
                  <div className="col-span-1 lg:col-span-1">
                  <input type="text" name="Address1" onChange={e=>setAddress1(e.target.value)} 
                  className="form-input w-full p-2 border border-gray-300 rounded" 
                  placeholder="Sender's Address"/>
                  </div>

                  <div className="col-span-1 lg:col-span-1">
                  <input type="text" name="Address2" onChange={e=>setAddress2(e.target.value)} 
                  className="form-input w-full p-2 border border-gray-300 rounded" 
                  placeholder="Receiver's address"/>
                  </div>

                  <div className="col-span-1 lg:col-span-1">
                  <input type="text" name="Distance" onChange={e=>setDistance(e.target.value)} 
                  className="form-input w-full p-2 border border-gray-300 rounded" 
                  placeholder="Distance between the source and destination" /><br/>
                  </div>
                  ...
                  <div className="col-span-1 lg:col-span-1">
                    ...
                    bg-purple-600 text-white rounded hover:bg-purple-700 focus:outline-none focus:ring-2
                      focus:ring-purple-500 focus:ring-opacity-50"  value="Submit">
                      Get Estimate
                    </button>
                   </div>
                 ...
                 <div>
                  <h4  className="form-input w-full p-2 border border-gray-300 rounded" > Your delivery estimate is  $ ${Price}</h4>
                </div>
