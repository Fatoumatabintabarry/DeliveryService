...
/* This component is a little confirmation of order generation  */
...
const OrderConfirmation = () => {
  return (
    ...
    <div class="rounded-lg bg-gray-50 px-16 py-14">
        ...
        <button class="mx-auto mt-10 block rounded-xl border-4 border-transparent bg-purple-400 px-6 py-3 text-center text-base font-medium text-orange-100 outline-8 hover:outline hover:duration-300">Track Order</button>
    </div>
    </div>
